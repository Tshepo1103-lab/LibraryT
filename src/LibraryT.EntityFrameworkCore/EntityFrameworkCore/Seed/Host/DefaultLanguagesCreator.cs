...
namespace LibraryT.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly LibraryTDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = LibraryTConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(LibraryTDbContext context)
        {
            _context = context;
        }
