...
namespace LibraryT.Migrations
{
    ...
    partial class LibraryTDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryT.Domain.AppConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LibraryT.Domain.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LibraryT.Domain.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LibraryT.Domain.Fine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LibraryT.Domain.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LibraryT.Domain.Person", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LibraryT.Domain.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LibraryT.Domain.Shelf", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LibraryT.Domain.TradingHour", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TradingHours", (string)null);
                });

            modelBuilder.Entity("LibraryT.Domain.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("LibraryT.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("LibraryT.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("LibraryT.Domain.Book", b =>
                {
                    b.HasOne("LibraryT.Domain.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("LibraryT.Domain.Category", b =>
                {
                    b.HasOne("LibraryT.Domain.Shelf", "Shelf")
                        .WithMany()
            ...
            modelBuilder.Entity("LibraryT.Domain.Fine", b =>
                {
                    b.HasOne("LibraryT.Domain.Transaction", "Transaction")
                        .WithMany()
            ...
            modelBuilder.Entity("LibraryT.Domain.Person", b =>
                {
                    b.HasOne("LibraryT.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("LibraryT.Domain.Review", b =>
                {
                    b.HasOne("LibraryT.Domain.Book", "Book")
                        .WithMany()
