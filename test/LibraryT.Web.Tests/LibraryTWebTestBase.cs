...
{
    public abstract class LibraryTWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LibraryTWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LibraryTWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LibraryTDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LibraryTDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LibraryTDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LibraryTDbContext, Task<T>> func)
        {
            T result;
